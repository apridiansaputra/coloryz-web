  ...
  if (view === "HOME") {
    return (
      <div className="min-h-screen relative overflow-hidden font-sans" style={{
        ...
        <main className="flex flex-col items-center justify-between min-h-screen p-6 text-center relative z-10">
          
          <div className="w-full pt-8">
            <h1 className="text-4xl font-bold mb-2 tracking-wide" style={{
          ...
          <div className="flex-1 flex flex-col justify-center w-full max-w-md">
            ...
            <p className="text-white text-sm leading-relaxed mb-10 px-4 opacity-90">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-10">
              <div className="bg-white/5 backdrop-blur-md rounded-xl px-4 py-2.5 flex items-center gap-2 border" 
                ...
                <span className="text-white text-xs font-medium text-left">Kejelasan Warna Inklusif</span>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-md rounded-xl px-4 py-2.5 flex items-center gap-2 border" 
                ...
                <span className="text-white text-xs font-medium text-left">Deteksi Warna Dominan</span>
              </div>
      ...
      <div className="w-full max-w-md mx-auto">
        <div className="px-6 py-6 flex items-center justify-between relative z-20">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold" style={{ color: '#7B61FF' }}>ColoryZ</h2>
          </div>
        ...
        <main className="flex flex-col p-6 pb-8 h-full">
